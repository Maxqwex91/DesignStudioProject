...
namespace DAL.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeStackTechnologies",
                columns: table => new
                {
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    StackTechnologyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeStackTechnologies", x => new { x.EmployeeId, x.StackTechnologyId });
                    table.ForeignKey(
                        name: "FK_EmployeeStackTechnologies_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeStackTechnologies_StackTechnologies_StackTechnologyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeLogs_EmployeeProjects_EmployeeId_ProjectId",
                        columns: x => new { x.EmployeeId, x.ProjectId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStackTechnologies_StackTechnologyId",
                table: "EmployeeStackTechnologies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeLogs_EmployeeId_ProjectId",
                table: "TimeLogs",
